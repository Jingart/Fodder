...
CREATE TABLE `shoppinglistitems` (
  ...
  CONSTRAINT `shoppinglistitems_ibfk_3` FOREIGN KEY (`priceid`) REFERENCES `itemprice` (`priceid`),
...
INSERT INTO `shoppinglist` VALUES ('6', '2015-10-18 00:00:00', 'Jan-Ingar', '1', null);
